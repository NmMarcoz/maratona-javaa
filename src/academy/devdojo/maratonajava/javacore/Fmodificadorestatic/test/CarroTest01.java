...
public class CarroTest01 {
    public static void main(String[] args){
        ...
        Carro.setLimVelo(210); //Por se tratar de um modificador static ele afeta a classe em si, não só o objeto. Ah, ele é public tb
        System.out.println("Velocidade limite depois da alteração é: " + Carro.getLimVelo());
        System.out.println("--------");
        c1.console();
        System.out.println("--------");
        c2.console();
